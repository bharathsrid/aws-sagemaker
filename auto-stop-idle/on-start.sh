...
(crontab -l 2>/dev/null; echo "0 0-9,17-23 * * * $PYTHON_DIR $PWD/autostop.py --time $IDLE_TIME --LRPath $LONG_RUNNING_CHECK_FILE_PATH --ignore-connections >> /var/log/jupyter.log") | crontab -